...
const DRAFT_KEY = (userId: string) => `mentor-draft-${userId}`;
...
export default function MentorSignupPage() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (d.menteesCount !== undefined) setMenteesCount(d.menteesCount);
      if (d.wasMentee !== undefined) setWasMentee(d.wasMentee);
      if (d.isReturning !== undefined) setIsReturning(d.isReturning);
      if (d.raceEthnicOrigin !== undefined) setRaceEthnicOrigin(d.raceEthnicOrigin);
    ...
    try {
      localStorage.setItem(
        ...
        JSON.stringify({
          ...
          inWaterloo, isInternational, menteesCount, wasMentee, isReturning,
          raceEthnicOrigin, gender, sexualOrientation, isIndigenous,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const result = await applicationService.submitMentorApplication({
        ...
        // Page 2
        race_ethnic_origin: raceEthnicOrigin,
        gender,
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {currentStep === 1 && (
              <Page1
                ...
                menteesCount={menteesCount} setMenteesCount={setMenteesCount}
                wasMentee={wasMentee} setWasMentee={setWasMentee}
            ...
            {currentStep === 2 && (
              <Page2
                raceEthnicOrigin={raceEthnicOrigin} setRaceEthnicOrigin={setRaceEthnicOrigin}
                gender={gender} setGender={setGender}
                sexualOrientation={sexualOrientation} setSexualOrientation={setSexualOrientation}
                isIndigenous={isIndigenous} setIsIndigenous={setIsIndigenous}
